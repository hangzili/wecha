...
class LoginController extends Controller
{
    ...
    public function wecha_login()
    {
    	...
    	$url= 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxcc4c342a42f5b788&redirect_uri=http://http://47.94.20.198/wechat/kess_add&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect';
    	header('Location:'.$url);
    }
    //授权登陆后获取关注着的基本信息
