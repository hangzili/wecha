    ...
    <div class="weui-tab__bd proinfo-tab-con">
      <div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
        ...
        <div class="swiper-container swiper-zhutu">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="{{ asset('storage/'.$v->goods_img) }}" /></div>
            <div class="swiper-slide"><img src="tel/upload/zhutu02.jpg" /></div>
          </div>
          <div class="swiper-pagination swiper-zhutu-pagination"></div>
        </div>
        <div class="wy-media-box-nomg weui-media-box_text">
          <h4 class="wy-media-box__title">{{ $v->goods_name }}</h4>
          <div class="wy-pro-pri mg-tb-5">¥<em class="num font-20">{{ $v->shop_price }}</em></div>
      ...
      <div id="tab2" class="weui-tab__bd-item ">
        <div class="pro-detail">
          <img src="tel/upload/xq1.jpg" /><img src="tel/upload/xq2.jpg" /><img src="tel/upload/xq3.jpg" /><img src="tel/upload/xq4.jpg" /><img src="tel/upload/xq5.jpg" /><img src="tel/upload/xq6.jpg" /><img src="tel/upload/xq7.jpg" /><img src="tel/upload/xq8.jpg" /><img src="tel/upload/xq9.jpg" />
        </div>
      </div>
      <div id="tab3" class="weui-tab__bd-item">
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            <div class="weui-cell nopd weui-cell_access">
              <div class="weui-cell__hd"><img src="tel/upload/headimg.jpg" alt="" style="width:20px;margin-right:5px;display:block"></div>
            ...
            <ul class="weui-uploader__files clear mg-com-img">
                <li class="weui-uploader__file" style="background-image:url(./tel/upload/pro3.jpg)"></li>
                <li class="weui-uploader__file" style="background-image:url(./tel/upload/pro3.jpg)"></li>
                <li class="weui-uploader__file" style="background-image:url(./tel/upload/pro3.jpg)"></li>
            </ul>
          </div>
        ...
        <div class="weui-panel__bd">
          <div class="wy-media-box weui-media-box_text">
            ...
            <p class="weui-media-box__desc">面料不错，码数也正常  男朋友面料不错，码数也正常  男朋友穿的面料不错，码数也正常  男朋友穿的穿的很合适。</p>
            <ul class="weui-uploader__files clear mg-com-img">
                <li class="weui-uploader__file" style="background-image:url(./tel/upload/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-uploader__file" style="background-image:url(./tel/upload/ban2.jpg)" onclick="window.location.reload('gallery.html')"></li>
                <li class="weui-uploader__file" style="background-image:url(./tel/upload/pro3.jpg)" onclick="window.location.reload('gallery.html')"></li>
            </ul>
          </div>
        </div>
...
<div class="weui-tabbar wy-foot-menu">
  ...
  <a href="javascript:;" id='show-toast' goods_id="{{ $list[0]['goods_id'] }}" class="promotion-foot-menu-items">
    <div class="weui-tabbar__icon promotion-foot-menu-collection"></div>
    <p class="weui-tabbar__label">收藏</p>
  </a>
  <a href="/shopcart" class="promotion-foot-menu-items">
 ...
 @foreach($list as $k=>$v)
  <p class="promotion-foot-menu-label" id="addcar" goods_id="{{ $v->goods_id }}">加入购物车</p>
  @endforeach
      ...
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="/shopcart" class="weui-btn weui-btn_primary">去购物车结算</a>
  ...
  <div class="weui-popup__modal">
    ...
    <div class="modal-content">
      <div class="weui-msg" style="padding-top:0;">
        ...
        <div class="weui-msg__opr-area">
          <p class="weui-btn-area">
            <a href="/order_info" class="weui-btn weui-btn_primary">立即购买</a>
            <a href="javascript:;" class="weui-btn weui-btn_default close-popup">不，我再看看</a>
          </p>
        </div>
      </div>
