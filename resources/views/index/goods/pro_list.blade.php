...
<div class="weui-content" style="padding-top:85px;">
  ...
  <div id="list" class='demos-content-padded proListWrap'>
    <div class="pro-items">
      <a href="/pro_info?goods_id={{ $v->goods_id }}" class="weui-media-box weui-media-box_appmsg">
        <div class="weui-media-box__hd"><img class="weui-media-box__thumb" src="{{ asset('storage/'.$v->goods_img) }}" alt=""></div>
