...
<head>
	...
	<style type="text/css">
		...
		.explode {background: url(/admin/images/menu_minus.gif) no-repeat 0px 3px; font-weight: bold;}
		.collapse { background: url(/admin/images/menu_plus.gif) no-repeat 0px 3px; font-weight: bold;}
		.menu-item { background: url(/admin/images/menu_arrow.gif) no-repeat 0px 3px; font-weight: normal;}
...
<body>
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="/admin/images/menu_minus.gif" width="9" height="9" border="0" alt="闭合"></a>
			</span>
	...
	<div id="main-div">
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 订单管理        
					<ul>
						  <li class="menu-item"><a href="/orderlist" target="main-frame">订单列表</a></li>
        ...
        <li class="explode" key="02_cat_and_goods" name="menu"> 商品管理       
          <ul>
              <li class="menu-item"><a href="/goods_list" target="main-frame">商品列表</a></li>
              <li class="menu-item"><a href="/goods_add" target="main-frame">商品添加</a></li>
          </ul>
        </li>
...
function toggleCollapse()
{
  ...
  collapse = !collapse;
  document.getElementById('toggleImg').src = collapse ? '/admin/images/menu_minus.gif' : '/admin/images/menu_plus.gif';
